...
%><jsp:useBean id="articleQH" scope="page" class="com.jalios.jcms.handler.QueryHandler"><%
  ...
  %><jsp:setProperty name="articleQH" property="types" value="<%= new String[] { Content.class.getName() }  %>"/><%
%></jsp:useBean><%
...
<div class="article-gallery article-unifiedinsert ajax-refresh-div"
 ...
 <div class="container-fluid">
  ...
  <jalios:cards mode="<%= CardsDisplayMode.DECK %>">
    <jalios:foreach name="article" type="Content" collection="<%= qrs.getAsSortedSet(articleQH.getSort(), articleQH.getReverse()) %>"
